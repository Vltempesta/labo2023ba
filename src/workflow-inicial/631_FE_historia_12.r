...
PARAM <- list()
PARAM$experimento <- "FE631112"

PARAM$exp_input <- "DR621112"
...
PARAM$RandomForest$mtry <- 30
PARAM$RandomForest$semilla <- 100129 # cambiar por la propia semilla


# varia de 0.0 a 2.0, si es 0.0 NO se activan
PARAM$CanaritosAsesinos$ratio <- 0.8
# desvios estandar de la media, para el cutoff
PARAM$CanaritosAsesinos$desvios <- 0.25
